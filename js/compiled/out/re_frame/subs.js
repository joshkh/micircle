...
var args24339 = [];
var len__19364__auto___24343 = arguments.length;
var i__19365__auto___24344 = (0);
while(true){
if((i__19365__auto___24344 < len__19364__auto___24343)){
args24339.push((arguments[i__19365__auto___24344]));

var G__24345 = (i__19365__auto___24344 + (1));
i__19365__auto___24344 = G__24345;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___24347 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__24338_SHARP_){
if(!((p1__24338_SHARP_ == null))){
if((false) || (p1__24338_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___24347){
var not_reactive_24348 = temp__4425__auto___24347;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_24348);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1463475582099
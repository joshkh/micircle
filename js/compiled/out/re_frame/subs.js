...
var args14760 = [];
var len__7322__auto___14764 = arguments.length;
var i__7323__auto___14765 = (0);
while(true){
if((i__7323__auto___14765 < len__7322__auto___14764)){
args14760.push((arguments[i__7323__auto___14765]));

var G__14766 = (i__7323__auto___14765 + (1));
i__7323__auto___14765 = G__14766;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args14760.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___14768 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__14759_SHARP_){
if(!((p1__14759_SHARP_ == null))){
if((false) || (p1__14759_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___14768){
var not_reactive_14769 = temp__4657__auto___14768;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_14769);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1470137667863
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__14823){
...
return cljs.core.get_in.call(null,new_db,p1__14824_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__14825_SHARP_){
return cljs.core.get_in.call(null,db,p1__14825_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__14826__i = 0, G__14826__a = new Array(arguments.length -  2);
while (G__14826__i < G__14826__a.length) {G__14826__a[G__14826__i] = arguments[G__14826__i + 2]; ++G__14826__i;}
  in_paths = new cljs.core.IndexedSeq(G__14826__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__14827){
var f = cljs.core.first(arglist__14827);
arglist__14827 = cljs.core.next(arglist__14827);
var out_path = cljs.core.first(arglist__14827);
var in_paths = cljs.core.rest(arglist__14827);
...
//# sourceMappingURL=middleware.js.map?rel=1470137669791
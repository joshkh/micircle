...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__24386){
...
return cljs.core.get_in.call(null,new_db,p1__24387_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__24388_SHARP_){
return cljs.core.get_in.call(null,db,p1__24388_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__24389__i = 0, G__24389__a = new Array(arguments.length -  2);
while (G__24389__i < G__24389__a.length) {G__24389__a[G__24389__i] = arguments[G__24389__i + 2]; ++G__24389__i;}
  in_paths = new cljs.core.IndexedSeq(G__24389__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__24390){
var f = cljs.core.first(arglist__24390);
arglist__24390 = cljs.core.next(arglist__24390);
var out_path = cljs.core.first(arglist__24390);
var in_paths = cljs.core.rest(arglist__24390);
...
//# sourceMappingURL=middleware.js.map?rel=1463475582305
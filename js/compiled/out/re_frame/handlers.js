...
var seq__24288 = cljs.core.seq.call(null,factory_names_in.call(null,v));
var chunk__24289 = null;
var count__24290 = (0);
var i__24291 = (0);
while(true){
if((i__24291 < count__24290)){
var name = cljs.core._nth.call(null,chunk__24289,i__24291);
re_frame.utils.error.call(null,"re-frame: \"",name,"\" used incorrectly. Must be used like this \"(",name," ...)\", whereas you just used \"",name,"\".");

var G__24292 = seq__24288;
var G__24293 = chunk__24289;
var G__24294 = count__24290;
var G__24295 = (i__24291 + (1));
seq__24288 = G__24292;
chunk__24289 = G__24293;
count__24290 = G__24294;
i__24291 = G__24295;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__24288);
if(temp__4425__auto__){
var seq__24288__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24288__$1)){
var c__19109__auto__ = cljs.core.chunk_first.call(null,seq__24288__$1);
var G__24296 = cljs.core.chunk_rest.call(null,seq__24288__$1);
var G__24297 = c__19109__auto__;
var G__24298 = cljs.core.count.call(null,c__19109__auto__);
var G__24299 = (0);
seq__24288 = G__24296;
chunk__24289 = G__24297;
count__24290 = G__24298;
i__24291 = G__24299;
continue;
} else {
var name = cljs.core.first.call(null,seq__24288__$1);
re_frame.utils.error.call(null,"re-frame: \"",name,"\" used incorrectly. Must be used like this \"(",name," ...)\", whereas you just used \"",name,"\".");

var G__24300 = cljs.core.next.call(null,seq__24288__$1);
var G__24301 = null;
var G__24302 = (0);
var G__24303 = (0);
seq__24288 = G__24300;
chunk__24289 = G__24301;
count__24290 = G__24302;
i__24291 = G__24303;
continue;
}
} else {
...
var args24304 = [];
var len__19364__auto___24307 = arguments.length;
var i__19365__auto___24308 = (0);
while(true){
if((i__19365__auto___24308 < len__19364__auto___24307)){
args24304.push((arguments[i__19365__auto___24308]));

var G__24309 = (i__19365__auto___24308 + (1));
i__19365__auto___24308 = G__24309;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args24304.length)].join('')));
...
var _STAR_handling_STAR_24312 = re_frame.handlers._STAR_handling_STAR_;
re_frame.handlers._STAR_handling_STAR_ = event_v;

try{return handler_fn.call(null,re_frame.db.app_db,event_v);
}finally {re_frame.handlers._STAR_handling_STAR_ = _STAR_handling_STAR_24312;
}}
}
});

//# sourceMappingURL=handlers.js.map?rel=1463475581946
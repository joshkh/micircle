...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__18904__auto__,writer__18905__auto__,opt__18906__auto__){
return cljs.core._write.call(null,writer__18905__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18306__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18306__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18306__auto__)){
return or__18306__auto__;
} else {
...
var G__24108 = o;
(G__24108[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__24109__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__24109 = function (var_args){
var args = null;
...
while (G__24110__i < G__24110__a.length) {G__24110__a[G__24110__i] = arguments[G__24110__i + 0]; ++G__24110__i;}
  args = new cljs.core.IndexedSeq(G__24110__a,0);
} 
return G__24109__delegate.call(this,args);};
G__24109.cljs$lang$maxFixedArity = 0;
G__24109.cljs$lang$applyTo = (function (arglist__24111){
var args = cljs.core.seq(arglist__24111);
return G__24109__delegate(args);
});
...
var old_24112 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24112))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24112)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18294__auto__ = (node === document.activeElement);
if(and__18294__auto__){
var and__18294__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18294__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24115 = jsprops;
(G__24115["defaultValue"] = value);

(G__24115["onChange"] = ((function (G__24115,v,value,on_change){
return (function (p1__24113_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24113_SHARP_);
});})(G__24115,v,value,on_change))
);
...
var vec__24117 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24117,(0),null);
var id = cljs.core.nth.call(null,vec__24117,(1),null);
var class$ = cljs.core.nth.call(null,vec__24117,(2),null);
...
var temp__4427__auto__ = (function (){var G__24121 = cljs.core.meta.call(null,v);
var G__24121__$1 = (((G__24121 == null))?null:reagent.impl.template.get_key.call(null,G__24121));
return G__24121__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24123_24124 = v;
var G__24123_24125__$1 = (((G__24123_24124 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24123_24124));
var G__24123_24126__$2 = (((G__24123_24125__$1 == null))?null:(jsprops["key"] = G__24123_24125__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__24129 = cljs.core.meta.call(null,argv);
var G__24129__$1 = (((G__24129 == null))?null:reagent.impl.template.get_key.call(null,G__24129));
return G__24129__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__24130 = (((jsprops == null))?{}:jsprops);
(G__24130["key"] = key);
...
var G__24131 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24131;
continue;
}
} else {
...
var n__19209__auto___24132 = a.length;
var i_24133 = (0);
while(true){
if((i_24133 < n__19209__auto___24132)){
(a[i_24133] = reagent.impl.template.as_element.call(null,(a[i_24133])));
...
var a = cljs.core.into_array.call(null,s);
var n__19209__auto___24135 = a.length;
var i_24136 = (0);
while(true){
if((i_24136 < n__19209__auto___24135)){
var val_24137 = (a[i_24136]);
if((cljs.core.vector_QMARK_.call(null,val_24137)) && ((reagent.impl.template.key_from_vec.call(null,val_24137) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24136] = reagent.impl.template.as_element.call(null,val_24137));

var G__24138 = (i_24136 + (1));
i_24136 = G__24138;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18294__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18294__auto__){
return (ctx["no-key"]);
} else {
return and__18294__auto__;
...
var G__24140 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24140) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24140){
...
//# sourceMappingURL=template.js.map?rel=1463475581598
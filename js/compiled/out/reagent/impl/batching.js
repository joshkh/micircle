...
var or__18306__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18306__auto__)){
return or__18306__auto__;
} else {
var or__18306__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18306__auto____$1)){
return or__18306__auto____$1;
} else {
var or__18306__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18306__auto____$2)){
return or__18306__auto____$2;
} else {
var or__18306__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18306__auto____$3)){
return or__18306__auto____$3;
} else {
...
var n__19209__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19209__auto__)){
var c_24043 = (a[i]);
if(cljs.core.truth_((c_24043["cljsIsDirty"]))){
(c_24043["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__18904__auto__,writer__18905__auto__,opt__18906__auto__){
return cljs.core._write.call(null,writer__18905__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__24047 = c;
var G__24047__$1 = (((G__24047 == null))?null:(G__24047["props"]));
var G__24047__$2 = (((G__24047__$1 == null))?null:(G__24047__$1["argv"]));
return G__24047__$2;
});
...
var G__24049_24050 = (c["cljsRatom"]);
var G__24049_24051__$1 = (((G__24049_24050 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__24049_24050));

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1463475581306
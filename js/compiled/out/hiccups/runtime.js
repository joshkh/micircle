...
var _STAR_html_mode_STAR_23888 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_23888;
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__23889){
var vec__23891 = p__23889;
var name = cljs.core.nth.call(null,vec__23891,(0),null);
var value = cljs.core.nth.call(null,vec__23891,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null))){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__23892){
var vec__23895 = p__23892;
var tag = cljs.core.nth.call(null,vec__23895,(0),null);
var content = cljs.core.nthnext.call(null,vec__23895,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__23896 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__23896,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__23896,(1),null);
var id = cljs.core.nth.call(null,vec__23896,(2),null);
var class$ = cljs.core.nth.call(null,vec__23896,(3),null);
...
var vec__23898 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__23898,(0),null);
var attrs = cljs.core.nth.call(null,vec__23898,(1),null);
var content = cljs.core.nth.call(null,vec__23898,(2),null);
if(cljs.core.truth_((function (){var or__18306__auto__ = content;
...
//# sourceMappingURL=runtime.js.map?rel=1463475580983